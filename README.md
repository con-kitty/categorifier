...
- [Kitty.Plugin](./plugin/Kitty/Plugin.hs) - this is the entrypoint of the plugin, everything that
  hooks into GHC starts from here;
- [Kitty.Plugin.Core.Categorize](./plugin/Kitty/Plugin/Core/Categorize.hs) - the high-level logic of the
...
- [Kitty.Plugin.Hierarchy](./plugin/Kitty/Plugin/Hierarchy.hs) - the mappings from abstract
